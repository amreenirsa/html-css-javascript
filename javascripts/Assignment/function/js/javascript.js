...
$(".prompt1").click( function() {
	...
	function hello(){
jAlert("Hello World" ,"Hello World");
}
hello();
...
jPrompt("Please enter Your first name.","","first name", function(firstName) {
jPrompt("Please enter your last name.","","last name", function(lastName) {
	
	
	
	

jAlert( firstName + lastName  ,"Full Name");
...
$(".prompt4").click( function() {
  ...
  jPrompt("Please enter 1st number.","","1st number", function(num) {
jPrompt("Please enter 2nd number.","","2nd number", function(num2) {
