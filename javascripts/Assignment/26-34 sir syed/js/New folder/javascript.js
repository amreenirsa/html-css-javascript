...
$(".prompt15").click( function() {
 ...
 if(date <= 15){
	 ...
	 a = "First fifteen days of the month.";
	 }
	 
else
{ a = "Last days of the month.";}	 
...
jAlert(  d + "<b>" + " Days past since 1st Ramadan,2015 " + "</b>", "number of days past since 1st Ramadan");
